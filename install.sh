...
echo -e "            data-website=\"x\""
echo -e "            data-position=\"inline\"></script>${NC}"
echo ""
echo -e "  ${YELLOW}Next steps:${NC}"
echo -e "    1. Add your files to ${BOLD}$INSTALL_DIR/files/${NC}"
echo -e "    2. Edit ${BOLD}WEBSITE_CONFIG${NC} in $INSTALL_DIR/main.py to map files to websites"
echo -e "    3. Paste the script tag on your websites"
echo ""